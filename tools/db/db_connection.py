...
class Load:
    ...
    def insert_tweets_into_db(self, df, schema, table):
        '''
        ...
        print(f"{inserted_records} records have been inserted \n",
              f"{error_inserted_records} records haven't been inserted due to insert errors \n",
              f"{skipped_inserted_records} records haven't been inserted due to insert errors")
